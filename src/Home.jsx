...
export default () => (
  <Stack align='center' m='auto' p='1rem' maxW='40rem'>
    ...
    <Text>Magic: The Gathering is a card game where play requires holding "mana". Mana comes in five colors: red, white, black, green, and blue.</Text>
    <Text>This seemingly simple set becomes surprisingly complex because <Link to='/combos'>all combinations of zero, one, two, three, four, and five colors is considered</Link>.</Text>
